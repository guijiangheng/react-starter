...
export const Header: React.FC<HeaderProps> = memo(({ setSidebarOpen }) => {
  ...
  return (
    <>
      <header className="sticky z-30 top-0 bg-white border-b border-gray-200">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between -mb-px h-16">
            <div className="flex">
              <button
                type="button"
