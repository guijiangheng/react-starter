  ...
  <div className="col-span-full bg-white border border-gray-200 rounded-sm shadow-lg xl:col-span-6">
    ...
    <div className="p-3">
      <div>
        ...
        <ul className="my-1">
          <li className="flex px-2">
            <div className="flex-shrink-0 mr-3 my-2 w-9 h-9 bg-indigo-500 rounded-full">
              <svg
            ...
            <div className="flex flex-grow items-center py-2 text-sm border-b border-gray-100">
              <div className="flex flex-grow justify-between">
                <div className="self-center">
                  ...
                  mentioned{' '}
                  <a className="text-gray-800 font-medium" href="#0">
                    Sara Smith
                  </a>{' '}
                  in a new post
                </div>
      ...
      <div>
        ...
        <ul className="my-1">
          <li className="flex px-2">
            <div className="flex-shrink-0 mr-3 my-2 w-9 h-9 bg-light-blue-500 rounded-full">
              <svg
                className="w-9 h-9 text-light-blue-50 fill-current"
                viewBox="0 0 36 36"
              >
