    ...
    <div className="p-3">
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full">
          {/* Table header */}
          <thead className="text-gray-400 text-xs bg-gray-50 rounded-sm uppercase">
            <tr>
              <th className="p-2">
          ...
          {/* Table body */}
          <tbody className="text-sm font-medium divide-gray-100 divide-y">
            {/* Row */}
            <tr>
              <td className="p-2">
              ...
              <td className="p-2">
                <div className="text-light-blue-500 text-center">4.7%</div>
              </td>
            </tr>
            {/* Row */}
            <tr>
              ...
              <td className="p-2">
                <div className="text-light-blue-500 text-center">4.4%</div>
              </td>
            </tr>
            {/* Row */}
            <tr>
              ...
              <td className="p-2">
                <div className="text-light-blue-500 text-center">4.2%</div>
              </td>
            </tr>
            {/* Row */}
            <tr>
            ...
            <tr>
              ...
              <td className="p-2">
                <div className="text-light-blue-500 text-center">3.9%</div>
              </td>
            </tr>
          </tbody>
        </table>
